...
Day 1：[客观题_理论层面的单选题](./leigangblog/homework1.md) 

Day 2：[代码题_基于DCGAN，改写为LS-GAN](./leigangblog/homework2.md) 

Day 3：[代码题_填空补全基于pix2pix实现人脸卡通的预测代码](./leigangblog/homework3.md) 
